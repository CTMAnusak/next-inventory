...
export interface IReturnLog extends Document {
  ...
  returnerOffice?: string; // ออฟฟิศ/สาขาผู้คืนอุปกรณ์ (สำหรับผู้ใช้ประเภทสาขา) - backward compatibility
  returnerOfficeId?: string; // 🆕 Office ID สำหรับอ้างอิง
  returnerOfficeName?: string; // 🆕 Office Name (populated field)
...
const ReturnLogSchema = new Schema<IReturnLog>({
  ...
  returnerOffice: { type: String }, // ออฟฟิศ/สาขาผู้คืนอุปกรณ์ (สำหรับผู้ใช้ประเภทสาขา) - backward compatibility
  returnerOfficeId: { type: String }, // 🆕 Office ID สำหรับอ้างอิง
  returnerOfficeName: { type: String }, // 🆕 Office Name (populated field)
