...
import { snapshotConditionConfigBeforeChange, checkConditionConfigUsage } from '@/lib/equipment-snapshot-helpers';
...
export async function DELETE(
  ...
  try {
    ...
    if (inventoryUsage > 0 || logsUsage.isUsed) {
      ...
      return NextResponse.json(
        { 
          error: `ไม่สามารถลบสถานะอุปกรณ์ได้ เนื่องจากมีการใช้งาน ${totalUsage} รายการ (อุปกรณ์: ${inventoryUsage}, ประวัติ: ${logsUsage.total})`,
