...
const tutorialSteps: TutorialStep[] = [
  ...
  },
  {
    ...
    description: 'เมื่อพบปัญหาการใช้งานคอมพิวเตอร์ อินเทอร์เน็ต ระบบงาน หรืออุปกรณ์ IT ชำรุด สามารถแจ้งปัญหาได้ที่นี่ ทีม IT จะได้รับแจ้งและดำเนินการแก้ไขให้',
  ...
  },
  {
    ...
    description: 'หลังจากแจ้งปัญหา IT แล้ว คุณสามารถเข้ามาดูความคืบหน้าการแก้ไขปัญหา สถานะดำเนินงาน และผลการดำเนินงานของทีม IT ได้ที่นี่',
    target: '[data-tutorial="it-tracking-card"]',
    position: 'right'
  },
  {
    id: 'contact-it',
    title: '📞 ข้อมูลติดต่อทีม IT',
    description: 'หากต้องการติดต่อทีม IT โดยตรงเพื่อสอบถามข้อมูล ขอคำแนะนำ หรือแจ้งปัญหาเร่งด่วน สามารถดูข้อมูลการติดต่อ เบอร์โทร และช่องทางติดต่อได้ที่นี่',
